...
class ComputeContract(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=True)  # Set editable to True
...
class BYOCMessageState(models.Model):
    ...
    status = models.CharField(max_length=50, null=True) # 'progressing', 'completed', 'aborted','error'
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
